...
namespace EventFlow.Bookings.Presentation.ExceptionFilter;
/// <summary>
...
public class GlobalExceptionHandlingMiddleware
{
    ...
    private static string MapTitle(Exception ex)
      => ex switch
      {
          ...
          BookingLimitExceededException blex => $"Booking Limit Exceded: {blex.MaxLimit}",
          AccessDeniedException ade=> "Access Denied",
          _ => "Unknown Error"
      };
}