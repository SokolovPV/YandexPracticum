...
namespace TestEventsApi
{
  public class EventServiceTests
  {
    ...
    {
      var result = _service.GetEvents("Test", null, null, null, null);
...
// Тестирование пагинации
    ...
    {
        var result = _service.GetEvents(null, null, null, 3, 10);
        
        Assert.Equal(5, result.Events.Count); // Последние 5 элементов
...
/*
// Тест на получение несуществующего события
        [Fact]
        ...
        // Тест на обновление несуществующего события
        [Fact]
